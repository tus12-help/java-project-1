<%-- 
    Document   : dashboard
    Created on : 09-Jun-2024, 3:53:26 pm
    Author     : Kiran
--%>
                ...
                <ul class="navbar-nav">
                    <div class="fon">
                        <li class="nav-item active">
                            <a class="nav-link" href="#"><i class="fa fa-users" aria-hidden="true">Account</i><span class="sr-only">(current)</span></a>
                        </li>
                        <li class="nav-item active">
       ...
       <div class="row align-items-center text-center">
            <!--&nbsp;&nbsp;&nbsp;<div class="card bg-warning">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">View Account</p>
            ...
            <div class="card bg-danger">
                ...
                <div class="card-body">
                    ...
                    <p class="card-text">Edit Login Details</p>
                    <a href="#" target="_self" class="btn btn-primary">Edit</a>
                </div>
            </div>&nbsp;&nbsp;&nbsp;
            <div class="card bg-success">
                ...
                <div class="card-body">
                    ...
                    <a href="transfer.jsp" class="btn btn-primary">Transfer</a>
                </div>
            </div>
        </div><!-- comment -->
    </div>
        ...
        <div class="row align-items-center text-center text-light">
            &nbsp;&nbsp;&nbsp;  <div class="card bg-dark">
                ...
                <div class="card-body">
                    ...
                    <a href="statement.jsp" class="btn btn-primary">View</a>
                </div>
            </div>&nbsp;&nbsp;&nbsp;
            <div class="card bg-success">
               <i class="fa fa-inr fa-5x" aria-hidden="true"></i>
